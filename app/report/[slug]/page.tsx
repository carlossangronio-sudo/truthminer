    ...
    <main className="min-h-screen bg-[#f9f9fb] text-gray-900 dark:bg-slate-950 dark:text-slate-50">
      ...
      <div className="container mx-auto px-4 md:px-6 py-8 md:py-12 max-w-4xl">
        ...
        {report.imageUrl ? (
          ...
          <div className="mb-10 rounded-2xl overflow-hidden shadow-lg border border-gray-200 dark:border-slate-800 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-slate-800 dark:to-slate-900 h-64 flex items-center justify-center">
            <svg
              className="w-24 h-24 text-gray-400 dark:text-slate-600"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
